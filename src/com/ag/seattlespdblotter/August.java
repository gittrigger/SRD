...
public class August {
	...
	public static String title = "SPD Blotter";
    public static String dest = "http://feeds.feedburner.com/spdblotter?format=xml";
    public static String dataprovider = "com.ag.seattlespdblotter";
    public static Class lookupClass = com.ag.seattlespdblotter.Lookup.class;
    	
	//Visual
	public static int notifyimage = R.drawable.black;
